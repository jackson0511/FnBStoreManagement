...
namespace QuanLyQuanCafe.DAO
{
    public class AccountDAO
    {
        ...
        public bool UpdateAccount(string userName, string displayName, string password, string newPass){
            ...
            int result = DataProvider.Instance.ExecuteNonQuery("exec USP_UpdateAccount @userName , @displayName , @password , @newPassword ", new object[] { userName, displayName, hasPass, newPass });
            return result > 0;    
        }
        ...
        internal bool InsertAccount(string userName)
        {
